...
markdownTable ::
    (Eq id, Show id, ShowTerryId id, ShowCell v) =>
...
{- | Render packages directly as a Markdown table. Each package retains the
display precision configured by its dataset descriptor.
-}
markdownPakTable ::
