...
exp7a :: [CountryId] -> [(RegionId, [CountryId])] -> IO String
exp7a countries regionDef = do
    ...
    let gpc4 :: CountryTable3 
        ...
        ds1 = Dataset{dsShortName ="gnp"
                    ...
                    , dsDecimals = 0 
                    , dsExtensive = True}        
        --     -- (combineMdTables Multiply gdp3  pop3){colScale=Kilo}
        -- diff4 = (combineMdTables (Subtract) gdp3 pop3)
